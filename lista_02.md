...
Algoritmo "verificacaoDeIdade"
var
inteiros idade;
inicio
...
se idade < 16
imprimir "Nao pode votar"
se nao 
se 16 < idade < 18
imprimir "Voto facultativo"
se nao
se idade > 18
imprimir "Voto obrigatorio""
fim
...
Classe Retangulo:
    ...
    Atributos:
        - comprimento
        - altura
    Metodo Construtor(cor, vertices)
        Define o valor do atributo cor
        Define o valor do atributo comprimento
        Define o valor do atributo altura
...
Classe Circulo:
    ...
    Metodo Construtor(cor, diametro)
        Define o valor do atributo cor
        Define o valor do atributo diametro
